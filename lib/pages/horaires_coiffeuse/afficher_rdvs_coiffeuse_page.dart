...
//         final dateFormatted = DateFormat("dd MMM yyyy – HH:mm").format(rdv.dateHeure);
//
//         return Card(
//           elevation: 3,
//           shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
...
//             title: Text(
//               "${rdv.dateHeure.toLocal().toString().substring(0, 16)}",
//               style: const TextStyle(fontWeight: FontWeight.bold),
//             ),
//             subtitle: Text(
//               "${rdv.clientPrenom} ${rdv.clientNom} — ${rdv.totalPrix.toStringAsFixed(2)} € • ${rdv.dureeTotale} min",
//             ),
//           ),
//         );
//       },
...
// //   bool isLoading = true;
// //
// //   List<RdvConfirmation> actifs = [];
// //   List<RdvConfirmation> archives = [];
// //
// //   @override
// //   void initState() {
// //     super.initState();
...
// //   }
// //
// //   Widget _buildRdvList(List<RdvConfirmation> rdvs) {
// //     if (rdvs.isEmpty) {
// //       return const Center(child: Text("Aucun rendez-vous."));
// //     }
// //
...
// //             ),
// //             subtitle: Text(
// //               "${rdv.client.prenom} ${rdv.client.nom} — ${rdv.totalPrix.toStringAsFixed(2)} € • ${rdv.dureeTotale} min",
// //             ),
// //           ),
// //         );
// //       },
