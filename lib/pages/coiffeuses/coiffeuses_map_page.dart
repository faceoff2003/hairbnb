  ...
  Future<void> _fetchCoiffeuses() async {
    ...
    try {
      ...
      nearbyCoiffeuses = nearbyCoiffeuses.where((coiffeuse) {
        return coiffeuse['user']['uuid'] != currentUserUUID;
      }).toList();
                  ...
                  child: ListTile(
                    ...
                    trailing: Row(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            // 🚀 Aller vers la page du profil de la coiffeuse
                        ...
                        const SizedBox(width: 10), // Ajoute un espace entre les boutons
                        ElevatedButton(
                          onPressed: () {
                            // 🚀 **Démarrer une conversation avec la coiffeuse**
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ChatPage(
                                  ...
                                  coiffeuseId: coiffeuse['user']['uuid'],
                                  coiffeuseName:
                                  "${currentUserProvider.currentUser?.nom} ${currentUserProvider.currentUser?.prenom}",
                                ),
                              ),
                            );
                          },
