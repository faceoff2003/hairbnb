...
class PromotionItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 🔥 AMÉLIORATION : Utilisation de la nouvelle méthode pour calculer le prix avec réduction
          ...
          children: [
            Row(
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // 🔥 MISE À JOUR CRITIQUE : Ajout du salonId
                    showCreatePromotionModal(
                      context: context,
                      salonId: service.salonId, // 🔥 NOUVEAU : ID du salon
            ...
            // 🔥 NOUVEAU : Affichage de la prochaine promotion si elle existe
