...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    super.initState();
    chatId = widget.clientId.compareTo(widget.otherUserId) < 0
        ? "${widget.clientId}_${widget.otherUserId}"
        : "${widget.otherUserId}_${widget.clientId}";
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: otherUser != null && otherUser!.photoProfil != null
                      ? NetworkImage(_getProfileImageUrl(otherUser!.photoProfil),)
  ...
  String _getProfileImageUrl(String? photoProfil) {
    final String baseUrl = "http://192.168.0.248:8000/";

    if (photoProfil == null || photoProfil.isEmpty) {
      return "${baseUrl}media/photos/defaults/avatar.png"; // ✅ Fix: URL correcte
    }

    return Uri.encodeFull("$baseUrl$photoProfil").replaceAll("\\", "/");
  }
