...
//       debugPrint("***********Utilisateur connecté : ${userCredential.user?.email}***********");
//
//       // Étape 2 : Vider les champs de texte après succès
//       emailController.clear();
//       passwordController.clear();
//
//       // Étape 3 : Redirection après connexion réussie
//       Navigator.pushReplacement(
//         context,
//         MaterialPageRoute(builder: (context) => const HomePage()), // Redirige vers HomePage
//       );
//     } on FirebaseAuthException catch (e) {
//       // Gestion des erreurs Firebase
//       String message;
...
//       }
//
//       // Afficher l'erreur dans le debug et dans l'UI
//       debugPrint(message);
