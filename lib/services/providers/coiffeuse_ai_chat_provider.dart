...
class CoiffeuseAIChatProvider with ChangeNotifier {
  ...
  Future<CoiffeuseConversationDetail?> createNewConversation() async {
    ...
    try {
      ...
      // ✅ IMPORTANT: Notifier les listeners APRÈS avoir tout défini
      notifyListeners();

      // ✅ Vérification finale
      print("🎯 Conversation active finale: ${_activeConversation?.id}");
      print("🎯 Nombre de messages: ${_activeConversation?.messages.length}");
      ...
      _error = e.toString();
      _isLoading = false;
      _activeConversation = null; // ✅ S'assurer que c'est null en cas d'erreur
      notifyListeners();
      return null;
    }
  }
  ...
  //     _isLoading = false;
  //
  //     // ✅ IMPORTANT: Notifier les listeners APRÈS avoir défini _activeConversation
  //     notifyListeners();
  //
  //     // ✅ Log pour debug
  //     print("🎯 Nouvelle conversation créée - ID: ${_activeConversation?.id}");
  //     print("🎯 Conversation active définie: ${_activeConversation != null}");
  //
  //     // Retourner la conversation créée
  //     return _activeConversation;
  //   } catch (e) {
...
//   }
//
//   // Fonction pour nettoyer le texte si nécessaire
