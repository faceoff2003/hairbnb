...
import 'package:hairbnb/pages/panier/cart_page.dart'; // 👈 Assure-toi d'importer CartPage
...
class _CustomAppBarState extends State<CustomAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      actions: [
        Padding(
          padding: const EdgeInsets.only(right: 16), // 🔁 Recule vers la gauche (~1cm)
          child: IconButton(
            icon: const Icon(Icons.shopping_cart, size: 28, color: Colors.black), // 🛍️ Icône plus moderne
